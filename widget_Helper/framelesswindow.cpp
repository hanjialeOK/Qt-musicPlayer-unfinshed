...
//        QPoint pos = m_titlebar->mapFromGlobal(QPoint(static_cast<int>(x/dpr), static_cast<int>(y/dpr)));
...
//    }
    ...
    case WM_GETMINMAXINFO:{
        if (::IsZoomed(msg->hwnd)) {
            ...
            m_frames.setLeft(static_cast<int>(abs(frame.left)/dpr + 0.5));
            m_frames.setTop(static_cast<int>(abs(frame.bottom)/dpr + 0.5));
            m_frames.setRight(static_cast<int>(abs(frame.right)/dpr + 0.5));
            m_frames.setBottom(static_cast<int>(abs(frame.bottom)/dpr + 0.5));
